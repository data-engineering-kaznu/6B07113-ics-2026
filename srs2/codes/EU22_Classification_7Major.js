...
//******************************************************************************************************/
//******************************************************************************************************/
// Script to classify EU in seven major classes. This script classifies the study area into 7 major 
// landcover classes (Artificial land, Arable land, Woodland and Shrubland, Grassland, Bare land and lichens/moss
// Water, Wetlands) using a predefined training data and important features by 
...
//                     features.
//Outputs: 
//         - EU27 classification map of seven major classes. It is exported to user assets folder.
//******************************************************************************************************/
//******************************************************************************************************/
...
for(var g=0;g<7;g++){
  ...
  Export.image.toAsset({
    image: class_map,
    description: 'classificaon_map_7classes_geo'+(g+1).toString(),
    assetId: 'EU_7_major_geo'+(g+1).toString(),
    scale:10,
    region: geometry,
    maxPixels: 10e12
  });
